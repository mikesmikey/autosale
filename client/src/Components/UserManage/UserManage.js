        ...
        return (
            <div className="box">
                <div className="column is-user-popUp">
                    ...
                    <div>
                        <label className="label">ชื่อ</label>
                        <input className="input is-userName-width is-pulled-right" type="text" id="popAddUserName" />
                    </div>

                    <div>
                        <label className="label">นามสกุล</label>
                        <input className="input is-userName-width is-pulled-right" type="text" id="popAddLastName" />
                    </div>
                    ...
                    {this.props.selectedType === "student" ?
                        <select className="user-mange-select-box-popUp is-pulled-right" type="text" id="popAddPosition">
                            <option value="0"></option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
